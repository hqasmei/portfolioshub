  ...
  return (
    <div className="grid place-items-center">
      ...
      >
        ...
        />
        <div
          className={`absolute right-0 top-0 bottom-0 flex items-center justify-center w-9 h-9 rounded-full cursor-pointer transition-all duration-500 ${active ? 'transform translate-x-0' : ''}`}
